module.exports = {
  ...
  MAX_TRACK_ALLOWED_FOR_PLAYLIST: process.env.MAX_TRACK_ALLOWED_FOR_PLAYLIST,
  SPOTIFY_PLAYLIST_TRACK_OFFSET_START: process.env.SPOTIFY_PLAYLIST_TRACK_OFFSET_START,
};
