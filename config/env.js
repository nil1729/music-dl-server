module.exports = {
  DEV_ENV: "development",
  CORE_SERVICE_PORT: process.env.CORE_SERVICE_PORT,
  ...
  ACCESS_TOKEN_REFRESH_INTERVAL: Number(
    process.env.ACCESS_TOKEN_REFRESH_INTERVAL_MS
  ),
  MAX_RETRY: Number(process.env.MAX_RETRY),
  SPOTIFY_API_TIMEOUT: Number(process.env.SPOTIFY_API_TIMEOUT_MS),
  MAX_API_TIMEOUT: Number(process.env.MAX_API_TIMEOUT_MS),
  MUSIC_MAX_DURATION: Number(process.env.MUSIC_MAX_DURATION_MS),
  ...
  MAX_TRACK_ALLOWED_FOR_PLAYLIST: Number(
    process.env.MAX_TRACK_ALLOWED_FOR_PLAYLIST
  ),
  SPOTIFY_PLAYLIST_TRACK_OFFSET_START: Number(
    process.env.SPOTIFY_PLAYLIST_TRACK_OFFSET_START
  ),
  PLAYLIST_TRACK_SAVING_CHUNK_SIZE: Number(
    process.env.PLAYLIST_TRACK_SAVING_CHUNK_SIZE
  ),
  SPOTIFY_API_HOST: process.env.SPOTIFY_API_HOST,
  SPOTIFY_CACHE_TTL: {
    TRACK: Number(process.env.SPOTIFY_TRACK_CACHE_TTL_DURATION_MS),
    ALBUM: Number(process.env.SPOTIFY_ALBUM_CACHE_TTL_DURATION_MS),
    PLAYLIST: Number(process.env.SPOTIFY_PLAYLIST_CACHE_TTL_DURATION_MS),
  },
  MAX_CACHE_TTL: Number(process.env.MAX_CACHE_TTL_MS),
  MAX_SLEEP_DURATION: Number(process.env.MAX_SLEEP_DURATION_MS),
  CACHE_KEY_PREFIX: {
  ...
  CONSUMER_SLEEP_DURATION: Number(process.env.CONSUMER_SLEEP_DURATION_MS),
  IP_TRACKING_RUNNING_STATUS: process.env.IP_TRACKING_RUNNING_STATUS,
